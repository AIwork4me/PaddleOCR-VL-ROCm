...
- `Get-Item <omnidocbench-worktree>\eval-infra\01-omnidocbench\OmniDocBench\result\paddleocrvl_rocm_cdm_quick_match_metric_result.json | Format-List FullName,Length`: passed; source size `16380` bytes.
- `Get-Item <omnidocbench-worktree>\eval-infra\01-omnidocbench\OmniDocBench\result\paddleocrvl_rocm_cdm_quick_match_run_summary.json | Format-List FullName,Length`: passed; source size `10393` bytes.
- `Copy-Item <omnidocbench-worktree>\eval-infra\01-omnidocbench\OmniDocBench\result\paddleocrvl_rocm_cdm_quick_match_metric_result.json results\\omnidocbench\\v16\\paddleocrvl_rocm_cdm_quick_match_metric_result_windows_native_2026-07-11.json`: passed.
- `Copy-Item <omnidocbench-worktree>\eval-infra\01-omnidocbench\OmniDocBench\result\paddleocrvl_rocm_cdm_quick_match_run_summary.json results\\omnidocbench\\v16\\paddleocrvl_rocm_cdm_quick_match_run_summary_windows_native_2026-07-11.json`: passed.
