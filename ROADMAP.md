...
Priorities are ordered by evidence and user impact, not by feature count.
...
- Preserve the documented v0.1.0 public-network transport waiver; do not claim
  an empty-cache download passed.
